...
# Higher means easier, Lower means harder
def nodule_difficulty(nodule_bbox, image_area):
    return (((nodule_bbox[2]-nodule_bbox[0]) * (nodule_bbox[3]-nodule_bbox[1]))/image_area) * 100
...
class NoduleData(Dataset):
    ...
    def __getitem__(self, index):
        ...
        diff = nodule_difficulty(nodule_bbox, image_area)
